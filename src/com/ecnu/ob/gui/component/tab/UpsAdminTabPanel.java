...
public class UpsAdminTabPanel extends BaseTabPanel {

	//private List<ClusterInfo> clusters;
	private JButton btnExecuteUpsAdmin;
	 ...
	 * Create the panel.
	 */
	public UpsAdminTabPanel(String title,TabInfo tabInfo) {
		super(title);
		setLayout(null);
...
//						break;
		...
		this.btnExecuteUpsAdmin = new JButton("Execute");
		this.btnExecuteUpsAdmin.setText("Execute");
...
//			}
//		});
		btnExecuteUpsAdmin.setBounds(220, 140, 93, 30);
		add(btnExecuteUpsAdmin);
		...
		btnUpsAdminLog = new JButton("UPS Admin Log");
...
//		}
	...
	public void setAction(AbstractAction action, ActionType actionType) {
		...
		if(this.btnExecuteUpsAdmin != null && actionType == ActionType.EXECUTE_UPS_ADMIN) {
			this.btnExecuteUpsAdmin.setAction(action);
		}
		if(this.btnUpsAdminLog != null && actionType == ActionType.UPS_ADMIN_LOG) {

...
public class RsAdminTabPanel extends BaseTabPanel {

	//private List<ClusterInfo> clusters;
	private JButton btnExecuteRsAdmin;
	
	private JButton btnRsAdminLog;
	 ...
	 * Create the panel.
	 */
	public RsAdminTabPanel(String title,TabInfo tabInfo) {
		super(title);
		setLayout(null);
...
//						break;
		...
		this.btnExecuteRsAdmin = new JButton("Execute");
		this.btnExecuteRsAdmin.setText("Execute");
...
//			}
//		});
		btnExecuteRsAdmin.setBounds(220, 140, 93, 30);
		add(btnExecuteRsAdmin);
		...
		btnRsAdminLog = new JButton("Rs Admin Log");
		btnRsAdminLog.setBounds(323, 140, 120, 30);
		add(btnRsAdminLog);
	}
...
//		}
	...
	public void setAction(AbstractAction action, ActionType actionType) {
		...
		if(this.btnExecuteRsAdmin != null && actionType == ActionType.EXECUTE_RS_ADMIN) {
			this.btnExecuteRsAdmin.setAction(action);
		}
		if(this.btnRsAdminLog != null && actionType == ActionType.RS_ADMIN_LOG) {
			this.btnRsAdminLog.setAction(action);
		}
	}
}
